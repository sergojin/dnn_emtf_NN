...
entity relu_ap_fixed_24_14_5_3_0_ap_uint_8_relu_config12_s is
port (
...
architecture behav of relu_ap_fixed_24_14_5_3_0_ap_uint_8_relu_config12_s is 
    ...
    signal trunc_ln_fu_52_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal icmp_ln1494_1_fu_70_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln359_1_fu_76_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    select_ln1494_1_fu_86_p3 <= 
        trunc_ln359_1_fu_76_p4 when (icmp_ln1494_1_fu_70_p2(0) = '1') else 
        ap_const_lv8_0;
    select_ln1494_fu_62_p3 <= 
        trunc_ln_fu_52_p4 when (icmp_ln1494_fu_46_p2(0) = '1') else 
        ap_const_lv8_0;
    trunc_ln359_1_fu_76_p4 <= data_1_V_read(17 downto 10);
    trunc_ln_fu_52_p4 <= data_0_V_read(17 downto 10);
end behav;
