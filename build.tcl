...
update_ip_catalog -add_ip "$origin_dir/../../../../HLS4ML/keras-to-hls/l1muon-test2-reuse1_v7_pruned50_l1Reg_1e-7_250MHz/myproject_prj/solution1/impl/ip/cern-cms_hls_myproject_1_0.zip" -repo_path user_ip_repo

create_ip -name myproject -vendor "cern-cms" -library hls -module_name myproject_0
generate_target {instantiation_template} [get_files top/top.srcs/sources_1/ip/myproject_0/myproject_0.xci]
generate_target all [get_files top/top.srcs/sources_1/ip/myproject_0/myproject_0.xci]
export_ip_user_files -of_objects [get_files top/top.srcs/sources_1/ip/myproject_0/myproject_0.xci] -no_script -force -quiet
create_ip_run [get_files -of_objects [get_fileset sources_1] top/top.srcs/sources_1/ip/myproject_0/myproject_0.xci]
...
set files [list \
 ...
 "[file normalize "$origin_dir/cgn/clk_wiz_0/clk_wiz_0.xci"]"\
]
