...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module tanh_1_tanh_table4_rom (
...
initial begin
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram0);
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram1);
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram2);
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram3);
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram4);
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram5);
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram6);
    $readmemh("./tanh_1_tanh_table4_rom.dat", ram7);
end
...
tanh_1_tanh_table4_rom tanh_1_tanh_table4_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
