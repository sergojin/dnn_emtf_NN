...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module tanh_2_tanh_table1_rom (
...
initial begin
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram0);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram1);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram2);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram3);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram4);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram5);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram6);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram7);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram8);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram9);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram10);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram11);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram12);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram13);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram14);
    $readmemh("./tanh_2_tanh_table1_rom.dat", ram15);
end
...
tanh_2_tanh_table1_rom tanh_2_tanh_table1_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
