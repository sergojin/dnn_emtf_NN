...
#
# Generated by export_simulation on Mon Nov 05 09:47:25 CST 2018
#
################################################################################
...
'-reset_run' switch to the './inject_mem_64.sh' script.

./inject_mem_64.sh -reset_run
...
./inject_mem_64.sh -noclean_files

For more information on the script, please type './inject_mem_64.sh -help'.
