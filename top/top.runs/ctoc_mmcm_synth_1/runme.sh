...
HD_PWD='/home/sergo/cms-phase2-muon-trigger/projects/dnn_emtf_displayed/top/top.runs/ctoc_mmcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctoc_mmcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctoc_mmcm.tcl
