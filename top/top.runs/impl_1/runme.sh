...
HD_PWD='/home/sergo/cms-phase2-muon-trigger/projects/dnn_emtf_displayed/top/top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mtf7_core_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mtf7_core_top.tcl -notrace
