...
HD_PWD='/home/sergo/cms-phase2-muon-trigger/projects/dnn_emtf_displayed/top/top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mtf7_core_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mtf7_core_top.tcl
