...
architecture behav of product is 
    ...
    signal p_Val2_s_reg_59 : STD_LOGIC_VECTOR (36 downto 0);
    ...
    component myproject_mul_muljbC IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    myproject_mul_muljbC_U52 : component myproject_mul_muljbC
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 18,
    ...
    ap_return <= p_Val2_s_reg_59(36 downto 13);
